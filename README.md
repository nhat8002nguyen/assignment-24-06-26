...
Post content lives in `src/data/post.js` as plain data. Keeps the JSX components thin and makes it simple to swap in real content later.
...
When you click a TOC link, that item stays active until you scroll manually — otherwise the observer can overwrite the highlight mid-scroll. Small extra logic, but it matches how people expect navigation to feel.
